...
.L2:
	...
	ldr	r3, .L10+8     		@ r3 = &LUT
	mov	ip, #641728512 		@ ip = 641 728 512
	ldr	r2, [r3, #0]   		@ r2 = LUT[0] --> theta = LUT[0]
	mov	r3, #1275068416		@ r3 = 1 275 068 416
	add	r3, r3, #13369344 	@ r3 = 1 288 437 760
	add	ip, ip, #2506752	@ ip = 644 235 264
	mov	r1, #0				@ r1 = 0 --> r1 = i
	rsb	r2, r2, #0			@ r2 = -LUT[0] --> theta = f(=0) - LUT[0]
	add	r3, r3, #52480		@ r3 = 1 288 490 240 ~= 2M = u
	add	ip, ip, #9856		@ ip = 644 245 120 ~= M
	mov	r0, r1				@ r0 = 0 --> r0 = f
	b	.L5
.L9:
